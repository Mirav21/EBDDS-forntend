...
const AddProduct = () => {
  ...
  //   name: "milk",
  //   description: "Organic fresh milk with no preservatives.",
  //   productCategory: "PERISHABLE",
  //   basePrice: 56.0,
  //   totalStock: 500,
  //   currentStock: 500,
  //   image_url:
  //     "https://encrypted-tbn2.gstatic.com/shopping?q=tbn:ANd9GcQz7N1vHls93Z_1DMTp6PWxTD4Lm4K0FB_IxCdrOitipKcycBj2CT80Og74M93FsvAmG_7WVQNljnZsG85zUyrGIwLxty0o9Yb7hPIXYrX6DjSYaoWJpnBTXgs",
  //   minStockThreshold: 10,
  //   maxProfitMargin: 0.3,
  //   currentProfitMargin: 0.25,
  // });
  ...
  //   maxShelfLife: 30,
  //   currentDailySellingRate: 5.5,
  //   maxExpectedSellingRate: 10.0,
  //   qualityScore: 0.85,
  //   currentDemandLevel: 0.75,
  // });
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    value={formatDate(perishableDetails.manufacturingDate)}
                ...
                <div>
                  ...
                  <input
                    type="date"
                    name="expiryDate"
                    value={formatDate(perishableDetails.expiryDate)}
                    onChange={handlePerishableDetailsChange}
                    className="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                </div>
